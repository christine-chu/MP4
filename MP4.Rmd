...
WHERE hf.category = 'Player' AND s.yearID >= 2010 AND tf.active = 'Y' AND hf.inducted = 'Y';
")
...
ggplot(data = fame.players, aes(x = yearID, y = salary, color = franchName)) + geom_boxplot()

ggplot(data = players, aes(x = yearID, y = salary, color = franchName)) + geom_point()
```
